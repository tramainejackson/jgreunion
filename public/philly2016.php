...
<html lang="en-US">
<head>
<title>Jackson/Green Reunion Philly</title>
...
<link rel="stylesheet" type="text/css" href="/jgreunion/public/css/jgreunion.css"/>
<!--[if lte IE 9]> <script>window.open("/jgreunion/public/oldBrowser/index.php", "_self");</script><![endif]-->
<script src="/jgreunion/public/scripts/jquery-2.1.3.min.js"></script>
<script src="/jgreunion/public/scripts/jgreunion.js"></script>
</head>
<body>

	<?php
		$query2 = "SELECT *, CONCAT_WS(', ', adult_names, youth_names, children_names) AS membersNames, DATE_FORMAT(reg_date, '%m/%d/%y') AS dateFormed FROM philly_registration ORDER BY registration_id";
		$results2 = mysqli_query($connect, $query2) or die ("Unable to run query ".mysqli_connect_error());
	?>
	
	<div id="scroll_to_top"></div>
	<div id="overlay_PhillyPage"></div>
	<div id="loading_image"><image src="/jgreunion/public/images/ajax-loader (1).gif" /></div>
	...
	<div id="modals_div">
		...
		<div id="registered_modal">
			<div id="all_registered_user">
				<?php
					echo "<table id='registered_members'>
					...
					{
						echo "<tr>
							<td class='registeredModalTD'>".ucwords(strtolower($row2['registree_name']))."</td>
							<td class='registeredModalTD'>".$row2['dateFormed']."</td>
						</tr>";
					}
					echo "</table>";
				?>
	...
	<div id="reunion_page" class="reunion_page_class">
		<div class="reunion_content" id="hotel_information">
			...
			<div id="hotel_content">
				<img id="hotel_pic" src="/jgreunion/public/images/crowne-plaza-feasterville-trevose-2533231492-4x3.jpg"/>				
