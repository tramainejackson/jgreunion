...
@section('content')
	...
	<div id="reunion_page" class="container-fluid">
		<div id="row">
			<div class="col">
				<h1 id="text-center">Jackson/Green Family Reunion 2016</h1>
			</div>
		</div>
		
		<!-- Hotel information -->
		<div class="row" id="hotel_information">
